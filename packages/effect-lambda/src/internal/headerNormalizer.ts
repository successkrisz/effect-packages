 ...
 */
export const normalizeHeaders = (headers: { [key: string]: string | undefined }) =>
 ...
 */
export function headerNormalizer(event: AwsAPIGatewayProxyEvent): AwsAPIGatewayProxyEvent & {
	rawHeaders: AwsAPIGatewayProxyEvent['headers']
}
export function headerNormalizer(event: AwsAPIGatewayProxyEventV2): AwsAPIGatewayProxyEventV2 & {
	rawHeaders: AwsAPIGatewayProxyEventV2['headers']
}
export function headerNormalizer(event: AwsAPIGatewayProxyEvent | AwsAPIGatewayProxyEventV2) {
